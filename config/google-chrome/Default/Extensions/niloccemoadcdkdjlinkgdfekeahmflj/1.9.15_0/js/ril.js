...
var ril = (function() {
    ...
    function logout() {
        ...
        // Clear new experimental signup path reference
        setSetting("signupSameTab", undefined);
    ...
    function setupHeartbeat(callback) {
        ...
        if (typeof time == 'undefined' || ((now-time) > msInDay)) {
            ...
            // if (!isAuthorized() && (navigator.language == 'en-US' || navigator.language == 'en'))
            // {
            //     ril.sendAbTestRegister(getSetting('guid'),getSetting('oauth_token'),'signup_same_tab_v3',getSetting("signupSameTab"));
            // }
