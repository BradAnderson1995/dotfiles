...
function processPage() {  
  if (protocol == 'https:' && tldr_access == "warn" ) {
    proceed = window.confirm('The TLDR plugin has determined that you are on a secure (https) page. OK to continue? (you can change this setting in the TLDR options)');
  }
