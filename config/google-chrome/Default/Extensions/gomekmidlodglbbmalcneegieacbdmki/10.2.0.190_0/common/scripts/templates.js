...
{ // --- Templates Declaration
        ...
        "<div class='avast_os_ext_dnt_group_right' >",
          "<div class='avast_os_ext_dnt_group_right_wrapper' style='background-image:url({{wrapper}})' >",
            ...
            "<div class='avast_os_ext_dnt_group_right_text'>",
              "{{number}}",
            "</div>",
            "<div class='avast_os_ext_dnt_group_swicher' data-type='{{type}}' style='background-image:url({{swicher}}); {{position}}:-1px;'>",
            "</div>",
          "</div>",
        "</div>",
      "</div>",
   ...
   */
  messageBox: [
    '<div id="avast-inpage" class="aos aos-overlay aos-injected">',
      '<div class="aos-modal">',
        ...
        '<section class="aos-section aos-section-noborder aos-section-{{status}} aos-text">',
          ...
          '<p id="avast-body" class="aos-text-p-large">{{strings.message}}</p>',
        '</section>',
  ...
  messageBoxOld: [
  "<div id='avast-inpage' class='avast-overlay' style='background: url({{background}})'>",
