...
class ItemSimple(__gobject__gobject.GObject, Item):
    """
    Object GooCanvasItemSimple
    ...
    def check_in_path(self, *args, **kwargs): # real signature unknown
        pass

    def check_style(self, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_simple_create_path(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_simple_is_item_at(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_simple_paint(cls, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def do_simple_update(cls, *args, **kwargs): # real signature unknown
        pass

    def get_line_width(self, *args, **kwargs): # real signature unknown
        pass

    def get_path_bounds(self, *args, **kwargs): # real signature unknown
        pass

    def paint_path(self, *args, **kwargs): # real signature unknown
        pass

    def set_model(self, *args, **kwargs): # real signature unknown
        pass

    def user_bounds_to_device(self, *args, **kwargs): # real signature unknown
        pass

    def user_bounds_to_parent(self, *args, **kwargs): # real signature unknown
        pass
    ...
    bounds_x1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    bounds_x2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    bounds_y1 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    bounds_y2 = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
