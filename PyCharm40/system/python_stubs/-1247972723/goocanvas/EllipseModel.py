...
class EllipseModel(ItemModelSimple):
    """
    Object GooCanvasEllipseModel
    
    Properties from GooCanvasEllipseModel:
      center-x -> gdouble: Center X
        The x coordinate of the center of the ellipse
      center-y -> gdouble: Center Y
        The y coordinate of the center of the ellipse
      radius-x -> gdouble: Radius X
        The horizontal radius of the ellipse
      radius-y -> gdouble: Radius Y
