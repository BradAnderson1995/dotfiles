...
class ImageModel(ItemModelSimple):
    """
    Object GooCanvasImageModel
    
    Properties from GooCanvasImageModel:
      pattern -> GooCairoPattern: Pattern
      ...
      scale-to-fit -> gboolean: Scale To Fit
